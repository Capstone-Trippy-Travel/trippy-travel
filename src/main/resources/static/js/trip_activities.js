    ...
    $.ajax({
        ...
        success: function (locations) {
            ...
            for (let singleVenue of venues) {
                ...
                moreDetailsButton.setAttribute("class", "btn btn-primary detailsButton")
                moreDetailsButton.innerText="Details";
                venueDiv.appendChild(venueTitle);
                venueDiv.appendChild(venueLocation);
                venueDiv.appendChild(moreDetailsButton)
                ...
                moreDetailsButton.addEventListener("click", (event)=>{
                    ...
                    getSearchLocation(singleVenue.location.address+ " "+ singleVenue.location.city)
                    map.setZoom(15);
                        $.ajax({
                            dataType: "json",
