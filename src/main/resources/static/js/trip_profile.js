...
//     cardBody.innerHTML = html;
    ...
    counter.setAttribute("class", "counterDiv float-left col-6");
    commentLikeCounterDiv.appendChild(counter)
...
//creating the vote buttons, counter and div container to hold them,
    ...
    yesButton.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">\n' +
    ...
    counter.innerText='Vote Count: '+place.voteCount;
    ...
    noButton.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">\n' +
