...
//creating the vote buttons, counter and div container to hold them,
    ...
    if (place.usersPreviousVote === "like") {
        yesButton.setAttribute("class", "btn btn-success btn-sm")
    } else {
        yesButton.setAttribute("class", "btn btn-primary btn-sm")
    }
    yesButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">\n' +
    ...
    if (place.usersPreviousVote === "dislike") {
        ...
        noButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">\n' +
        ...
        commentButton.setAttribute("style", "background-color: grey; border:none; border-radius: 5%")
        commentButton.setAttribute("data-toggle", "modal")
        commentButton.setAttribute("data-target", "#modalPoll-1")
        commentButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg"  width="14" height="14" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16">\n' +
